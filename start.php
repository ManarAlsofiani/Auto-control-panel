...
if ($row['Rightt'] !== 0 &&  $row['Leftt'] !== 0 && $row['Forward'] !== 0) {
  ...
  ctx1.lineJoin = "miter";
  ctx1.miterLimit = 5;
  ctx1.moveTo(0+10, <?php echo $row['Forward'];?>-10);
  ctx1.lineTo(0, <?php echo $row['Forward'];?>);
  ctx1.lineTo(0-10, <?php echo $row['Forward'];?> -10);
  ctx1.stroke();
  ...
  ctx.lineCap = "square";
  ctx.moveTo(0, 0);
  ctx.lineTo(0, <?php echo $row['Forward'];?>);
  ctx.stroke();
  ...
  ctx1.lineTo(<?php echo $row['Rightt'];?>, <?php echo $row['Forward'];?>);
  ...
  ctx.beginPath();
  ctx.lineCap = "square";
  ctx.moveTo(0, <?php echo $row['Forward'];?>);
  ...
  ctx1.lineJoin = "miter";
  ctx1.miterLimit = 5;
  ctx1.moveTo(<?php echo $row['Rightt'];?>+10, <?php echo $row['Forward'];?>+40);
  ctx1.lineTo(<?php echo $row['Rightt'];?>, <?php echo $row['Leftt'];?>);
  ctx1.lineTo(<?php echo $row['Rightt'];?>-10, <?php echo $row['Forward'];?> +40);
  ctx1.stroke();
